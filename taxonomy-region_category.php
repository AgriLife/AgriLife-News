<?php
/**
 * The template for displaying Region Category Archive pages.
 *
	...
	<section id="content" role="main" class="two-of-3 column">
			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					<h1 class="page-title section-title"><?php _e( 'Region', 'flexopotamus' ); ?>: <?php echo apply_filters( 'the_title', $term->name ); ?></h1>
				</header>
