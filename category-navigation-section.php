	...
	<section class="cat-nav-container clearfix">
		...
		<div class="mb-inner cat-nav-inner">
			<header class="mb-head cat-nav-head">
				<div class="cat-nm cat-nm-farm-ranch"><a href="<?php echo esc_url( $farm_ranch_cat_link ); ?>">Farm &amp; Ranch</a></div>
			</header>
		...
		<div class="mb-inner cat-nav-inner">
			<header class="mb-head cat-nav-head">
				<div class="cat-nm cat-nm-lawn-garden"><a href="<?php echo esc_url( $lawn_garden_cat_link ); ?>">Lawn &amp; Garden</a></div>
			</header>
		...
		<div class="mb-inner cat-nav-inner">
			<header class="mb-head cat-nav-head">
				<div class="cat-nm cat-nm-life-health"><a href="<?php echo esc_url( $life_health_cat_link ); ?>">Life &amp; Health</a></div>
			</header>
		...
		<div class="mb-inner cat-nav-inner">
			<header class="mb-head cat-nav-head">
				<div class="cat-nm cat-nm-environment"><a href="<?php echo esc_url( $environment_cat_link ); ?>">Environment</a></div>
			</header>
		...
		<div class="mb-inner cat-nav-inner">
			<header class="mb-head cat-nav-head">
				<div class="cat-nm cat-nm-business"><a href="<?php echo esc_url( $business_cat_link ); ?>">Business</a></div>
			</header>
		...
		<div class="mb-inner cat-nav-inner">
			<header class="mb-head cat-nav-head">
				<div class="cat-nm cat-nm-science-technology"><a href="<?php echo esc_url( $science_tech_cat_link ); ?>">Science &amp; Tech</a></div>
			</header>
